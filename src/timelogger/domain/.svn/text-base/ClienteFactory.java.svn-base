...
public class ClienteFactory {
	...
	public static Cliente loadClienteByORMID(PersistentSession session, int ID) {
		try {
			return (Cliente) session.load(timelogger.domain.Cliente.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			return null;
	...
	public static Cliente getClienteByORMID(PersistentSession session, int ID) {
		try {
			return (Cliente) session.get(timelogger.domain.Cliente.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			return null;
	...
	public static Cliente loadClienteByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) {
		try {
			return (Cliente) session.load(timelogger.domain.Cliente.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			return null;
	...
	public static Cliente getClienteByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) {
		try {
			return (Cliente) session.get(timelogger.domain.Cliente.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			return null;
	...
	public static Cliente[] listClienteByQuery(PersistentSession session, String condition, String orderBy) {
		StringBuffer sb = new StringBuffer("From timelogger.domain.Cliente as Cliente");
		if (condition != null)
	...
	public static Cliente createCliente() {
		return new timelogger.domain.Cliente();
	}
